...
// const API_KEY = "sk-svcacct-n8YRGVuz6JK8uXluyzvQWPcm2pElIPtclUB2LOtD1Q8B3qDl2FwSzMJv5uMW-xyjNT3BlbkFJMCEjKTWkWD-l7YcTzWVRIpRLBghcii7sbSqj-ZamOCxtMWH6cMWi_IJPNJmhJhDAA";
...
//     //set Typing indecator
//     setTyping(true);

//     //process message to ChatGpt (send ot over and see response)
...
//     // role: "user" -> a messgae form the user, "assistent" -> a response from chatGPT
//     //"system" -> generally one initial message defining HOW we want ChatGPT talk

//     const systemMessage = {
//       role: "system",
//       content: "Speak like a pirate" // Speak like a pirate, Explain like I am a 10
